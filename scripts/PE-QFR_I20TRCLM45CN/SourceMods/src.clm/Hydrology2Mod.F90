    ...
    do j = 1, nlevgrnd
       do fc = 1, num_hydrologyc
          ...
          if (h2osoi_liq(c,j) > 0._r8) then
             ...
             ! 04/07/2021 Fenghui Yuan modified for tropical peatland
             psi=10.0_r8*(((((vwc-0.45)/(watsat(c,j)-0.45))**(1.4_r8/(1.0_r8-1.4_r8)))-1.0_r8)/0.02_r8)**(1.0_r8/1.4_r8) !mm
              psi= psi* (-9.8e-6_r8) ! Mpa
